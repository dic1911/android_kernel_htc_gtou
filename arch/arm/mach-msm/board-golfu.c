...
static void golfu_camera_vreg_config(int vreg_en)
{
	...
	if (vreg_en) {
	 	/* for XB board with 5M and later*/
		/* D1V5 for 5M 4e1 */
...
static struct synaptics_i2c_rmi_platform_data golfu_ts_synaptics_data[] = { /* Synatpics sensor */
	{
		...
		.config = {
			
		},
	},
	{
		.version = 0x3332,
		.packrat_number = 1471135,
		.abs_x_min = 0,
		.abs_x_max = 1100,
		.abs_y_min = 0,
		.abs_y_max = 1690,
		...
		.config = {
			...
			0x02, 0x02, 0x02, 0x02, 0x02, 0x20, 0x20, 0x20,
			0x20, 0x20, 0x20, 0x20, 0x20, 0x57, 0x5A, 0x5C,
			0x5E, 0x60, 0x62, 0x64, 0x66, 0x00, 0x3C, 0x00,
			0x10, 0x28, 0x00, 0x00, 0x00, 0x02, 0x04, 0x06,
			0x08, 0x0A, 0x0C, 0x0D, 0x00, 0x31, 0x04, 0x00,
			0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
			0x00, 0x00, 0x00, 0x00, 0xFF, 0xFF, 0xFF, 0xFF,
			...
			0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80,
			0x80, 0x80, 0x00, 0x14, 0x01, 0x02, 0x36, 0x3F,
			0x08, 0xA8, 0x19, 0x02, 0x04, 0xB4, 0x01, 0x6E,
			0x03, 0x08
			},
	},
	{
		.version = 0x3332,
		.packrat_number = 1306588,
		.abs_x_min = 0,
		.abs_x_max = 1100,
		.abs_y_min = 0,
		.abs_y_max = 1720,
		...
		.config = {,
			...
			0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80,
			0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80, 0x80,
			0x80, 0x80, 0x00, 0x0F, 0x00, 0x4F, 0x53},
	},
	{
		.version = 0x3330,
		.abs_x_min = 0,
...
static void __init golfu_init(void)
{
...
#ifdef CONFIG_PERFLOCK
	golfu_perf_acpu_table[PERF_LOCK_HIGHEST] = get_max_cpu_freq() * 1000;
	...
	if (machine_is_golfu()) {
		...
		printk(KERN_INFO "golfu_init() don't register nfc driver\n");
